...
def train():
    ...
    ###========================== RESTORE MODEL =============================###
    sess = tf.Session(config=tf.ConfigProto(allow_soft_placement=True, log_device_placement=False, gpu_options=tf.GPUOptions(visible_device_list="0,1", allow_growth=True)))
...
def evaluate():
    ...
    save_dir = "samples_movie/{}".format(tl.global_flag['mode'])
    ...
    #valid_hr_img = valid_hr_imgs[imid]
        #valid_lr_img = scipy.misc.imread("./neko.png")
    valid_hr_img = get_imgs_fn('image_000001_mp4.png', './')  # if you want to test your own image
    name_valid_lr_img = args.valid_lr_img
    valid_lr_img = get_imgs_fn('{}'.format(name_valid_lr_img), './data_3gpp/image/')  # if you want to test your own image
    ...
    sess = tf.Session(config=tf.ConfigProto(allow_soft_placement=True, log_device_placement=False,gpu_options=tf.GPUOptions(visible_device_list="0,1")))
    tl.layers.initialize_global_variables(sess)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--valid_lr_img", type=str, help="path valid_lr_img")
